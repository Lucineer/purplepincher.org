# CLAUDE.md — purplepincher.org

Nonprofit umbrella for open-source agentic computing, Plato ecosystem philosophy, and fleet coordination.

## What This Repo Is
An active project repo in the Lucineer fleet.

## Boarding
1. Read this file (CLAUDE.md)
2. Check git log for recent activity
3. Read any docs/ or EXPERIENCE/ for context
